...
export function useFetchData<T>({
  ...
  const fetchData = useCallback(
    async (page: number) => {
      ...
      const queryParams = createQueryParams(page, offset, sortKey, sortDirection);
    ...
    [baseUrl, createQueryParams, pageSize, sortKey, sortDirection, extractDataFromResponse, extractTotalRecordsFromResponse, extractTimeFromResponse]
  );
  ...
  return { data, totalCount, time, error, isLoading, fetchData, sortKey, sortDirection, updateSorting };
}